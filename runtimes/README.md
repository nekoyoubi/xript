...
- **node/** (`@xriptjs/runtime-node`) — Node.js-optimized runtime using the `vm` module for sandboxed execution (includes `createRuntimeFromFile` and full JSON Schema validation)
