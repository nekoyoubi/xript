...
function generateModAmbientTypes(options: TemplateOptions): string {
	...
	return [
		"// Auto-generated by @xriptjs/typegen (ambient mode).",
		"// Regenerate with: npx xript typegen --ambient mod-manifest.json -o src/xript-env.d.ts",
		...
		"\t\t */",
		"\t\tnamespace fragment {",
		"\t\t\tfunction update(handler: (bindings: Record<string, unknown>) => void): void;",
		"\t\t}",
		"\t}",
		"",
		"\t/**",
