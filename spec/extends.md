...
- A child redeclaring a base `binding`, `capability`, or `hook` name is a resolution error — these maps are collision-as-error throughout; fill and refine are type and slot concerns.
