# Annotation Scanning Convention

This document defines the `@xript` JSDoc annotation convention for declaring manifest bindings directly in TypeScript source code. A scanner reads these annotations and generates the `bindings` and `capabilities` sections of an xript manifest.
