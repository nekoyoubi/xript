...
- **Publishing**: all 6 packages live on npm under `@xriptjs` scope, OIDC trusted publishing via `.github/workflows/publish.yml` (manual dispatch, no tokens needed), provenance attestations enabled
