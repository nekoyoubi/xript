...
The type generator (`@xriptjs/typegen`) reads an xript manifest and produces TypeScript definition files (`.d.ts`). This gives modders autocomplete, type checking, and inline documentation in their editors.
